...
from .models import ArquivoAta, AtaReuniao, CategoriaItemAta, ItemAta
    ...
    def __init__(self, *args, **kwargs):
        ...
        if user:
            if user.is_superuser:
                ...
                self.fields["contrato"].queryset = user.userprofile.contratos.filter(
                    ativo=True
                )
...
ItemAtaFormSet = inlineformset_factory(
    parent_model=AtaReuniao, model=ItemAta, form=ItemAtaForm, extra=0, can_delete=True
)
