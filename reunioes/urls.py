...
from .views import (AtaReuniaoCreateView, AtaReuniaoDeleteView,
                    AtaReuniaoDetailView, AtaReuniaoListView,
                    AtaReuniaoUpdateView, AtasAgrupadasView, GerarResumoIAView,
                    MenuAtasView, adicionar_arquivos_ata, excluir_arquivo_ata)
...
urlpatterns = [
    ...
    path(
        "adicionar-arquivos/<int:pk>/",
        adicionar_arquivos_ata,
        name="adicionar_arquivos_ata",
    ),
    path(
        "gerar-resumo/<int:ata_id>/",
        GerarResumoIAView.as_view(),
        name="gerar_resumo_ia",
    ),
]
